...
declare module '$env/static/private' {
	...
	export const VITE_GRAPHQL_API_URL: string;
	...
	export const npm_package_devDependencies__oslojs_crypto: string;
	export const npm_package_devDependencies__oslojs_encoding: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_devDependencies__oslojs_crypto: string;
		npm_package_devDependencies__oslojs_encoding: string;
