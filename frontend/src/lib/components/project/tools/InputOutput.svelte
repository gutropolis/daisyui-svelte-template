	...
	<div class="flex-1   flex-col  border-1 h-full p-5 w-full  bg-white shadow-sm   rounded-lg" style="box-shadow: 0px 0px 4px 0px #00000033;">
        ...
        <div class="space-y-4">
            <div class="w-full mb-5">
                ...
                <div  class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-5">
                    <div class="col-span-1 md:col-span-1">
                        <h6 class="font-semibold text-sm">Soil Profile</h6>
                    </div>
                    <div class="col-span-1 md:col-span-1 text-left md:text-right">
                        <h6 class="font-semibold text-sm">Passive Softening Depth = 1.00 m</h6>
                    </div>
                </div>
                <div class="relative overflow-x-auto sm:rounded mt-5 whitespace-nowrap">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 ">
                        <thead class="text-xs w-full text-blue-600 uppercase   border-b border-gray-300">
                            <tr>
                                <th scope="col" class="px-2 py-3" title="Depth">Depth (m)</th>
                                <th scope="col" class="px-2 py-3" title="Soil">Soil Name</th>
                                <th scope="col" class="px-2 py-3" title="γ"><span class="lowercase">γ</span> (kN/m<sup>3</sup>)</th>
                                <th scope="col" class="px-2 py-3"><span class="lowercase">γ</span><sub>1</sub> (kN/m<sup>3</sup>)</th>
                                <th scope="col" class="px-2 py-3">C (kN/m<sup>2</sup>)</th>
                                <th scope="col" class="px-2 py-3">C<sub>a</sub> (kN/m<sup>2</sup>)</th>
                                <th scope="col" class="px-2 py-3">φ  (degree)</th>
                                <th scope="col" class="px-2 py-3"><span class="lowercase">δ</span> (degree)</th>
                                <th scope="col" class="px-2 py-3">K<sub>a</sub></th>
                                <th scope="col" class="px-2 py-3">K<sub>ac</sub></th>
                                <th scope="col" class="px-2 py-3">K<sub>p</sub></th>
                                <th scope="col" class="px-2 py-3">K<sub>pc</sub></th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        {#each projSoils as soil}
                            <tr class="bg-white border-b">
                                <td class="px-2 py-2">{soil.depth}</td>
                                <td class="px-2 py-2">{soil.name}</td>
                                <td class="px-2 py-2">{soil.unitWeight}</td>
                                <td class="px-2 py-2">{soil.effectiveUnitWeight}</td>
                                
                                <td class="px-2 py-2">{soil.cohesion}</td>
                                <td class="px-2 py-2">{soil.adhesion}</td>
                                <td class="px-2 py-2">{soil.internalFriction}</td>
                                <td class="px-2 py-2">{soil.wallFrictionAngle}</td>
                                <td class="px-2 py-2">{soil.kActive}</td>
                                <td class="px-2 py-2">{soil.kAc}</td>
                                <td class="px-2 py-2">{soil.kPassive}</td>
                                <td class="px-2 py-2">{soil.kPc}</td>
                            </tr>
                        ...
                        {:else}
                            <tr class="bg-white border-b">
                                <td class="px-2 py-2" colspan="12">No soil is chosen</td>
                            </tr>
                        {/if}    
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 ">
                        ...
                        <tbody>
                            <tr class="bg-white border-b">
                                ...
                                <td class="px-2 py-2">96.58</td>
                                <td class="px-2 py-2">127.06</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                        ...
                        <table class="w-full text-sm text-left   text-gray-500">
                            ...
                            <tbody>
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-2 py-1">65466.7 KNm/m</td>
                                    <td class="px-2 py-1">71.26m</td> 
                                </tr>
                                <tr class="bg-white border-b">
                                ...
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-2 py-1">488.0 KN/m<sub>2</sub></td>
                                    <td class="px-2 py-1">30.49m</td> 
                                </tr>
                                <tr class="bg-white border-b">
                                    <th class=" px-2 py-1 text-blue-600 uppercase">Shear Force</th>
                                    <td class="px-2 py-1">3242.0 KN/m</td>
                                    <td class="px-2 py-1">31.13m</td> 
                                </tr>
