...
<div class="card bg-white shadow-lg">
	<div class="card-body space-y-6">
		...
		<div class="text-center space-y-2">
			...
			<h1 class="text-2xl font-bold text-gray-900">Welcome to Vuexy! 👋</h1>
			<p class="text-sm text-gray-600">Please sign-in to your account and start the adventure</p>
		</div>
		...
		<form method="POST" action="?/login" use:enhance class="space-y-4">
			...
			<div class="form-control">
				<label class="label" for="email">
					<span class="label-text text-gray-700">Email or Username</span>
				</label>
				<input
					id="email"
					name="email"
			...
			<div class="flex items-center justify-between">
				<label class="label cursor-pointer" for="remember">
					...
					/>
					<span class="label-text ml-2 text-gray-700">Remember Me</span>
				</label>
				<a href="/auth/forgot-password" class="link link-primary text-sm">Forgot Password?</a>
			</div>

			<!-- Login Button -->
			<button type="submit" class="btn btn-primary w-full text-white font-semibold"> Login </button>
		</form>
